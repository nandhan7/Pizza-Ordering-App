...
function Button({ children, disabled, to, type, onClick }) {
    ...
    const styles = {
        ...
        secondary:
            'inline-block text-sm rounded-full font-semibold uppercase border-2 border-stone-300 tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:bg-stone-300 focus:outline-none focus:text-stone-800 focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5',
